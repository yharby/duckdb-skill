...
| Measurement | `spatial/measurement.md` | ST_Area, ST_Distance, ST_Length, ST_Perimeter (+ _Spheroid/_Sphere variants), ST_Azimuth, ST_ShortestLine |
...
| Accessors | `spatial/accessors.md` | ST_X/Y/Z/M, ST_HasM/Z, ST_ZMFlag, ST_XMax/XMin/YMax/YMin/ZMax/ZMin/MMax/MMin, ST_Dimension, ST_NPoints, ST_NGeometries, ST_ExteriorRing, ST_PointN, ST_Points, ST_IsClosed/IsEmpty/IsRing/IsSimple/IsValid, ST_Extent, ST_Dump, ST_CollectionExtract, ST_Polygonize |
